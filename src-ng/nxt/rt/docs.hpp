...
/**
@page rt_overview nxt::rt runtime overview
...
@forgegraph{nxtrt/model.rkt,rich-runtime-shape-witness,nxt::rt runtime shape}
...
@section rt_io Byte streams and protocol helpers
...
Experimental async runtime primitives for `src-ng`.
