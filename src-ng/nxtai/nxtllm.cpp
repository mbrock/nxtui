...
using nxt::ai::llm::llm_request;
using nxt::ai::llm::default_max_output_tokens;
using nxt::ai::llm::frame_interval;
...
nxt::rt::task<int> run_nxtllm(cli_options options)
{
    ...
    nxt::ai::llm::prepare_tool_request(request, tools);
                        ...
                        return nxt::rt::with_ui_zone(
                            [request = std::move(request),
                             tools = std::move(tools)]() mutable {
                                return nxt::ai::llm::run_agent_ui_zone(
                                    std::move(request),
                                    std::move(tools));
                            },
                            {},
